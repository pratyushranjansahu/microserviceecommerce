...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
    	...
    	.antMatchers(HttpMethod.GET, environment.getProperty("api.catalog.url.path")).permitAll()
    	.antMatchers(HttpMethod.POST, environment.getProperty("api.order.url.path")).permitAll()
